...
function Home() {
  ...
  return (
    <div className='py-5 flex flex-col justify-center px-5'>
      <div className='flex flex-col md:flex-row py-5 justify-center items-center lg:items-start 2xl:items-center gap-3'>
        <img src={logo} className='w-[50%] lg:w-[35%]' />
        <div className='text-white p-2 xl:max-w-[400px]'>
          <p className='text-2xl font-bold'><span className='text-5xl'>S</span>kill Test</p>
