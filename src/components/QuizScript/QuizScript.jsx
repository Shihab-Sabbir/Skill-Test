        ...
        <div className='py-10'>
            {questions?.length === undefined ? <ErrorPage /> :
                <div>
                    ...
                    <p className='text-center text-yellow-400 p-2'><small>**Only first answer will be counted as correct or wrong for each question**</small></p>
                    <div className='text-center  flex flex-col md:flex-row justify-evenly p-2 border m-4 lg:max-w-[970px] lg:mx-auto lg:p-4 font-mono'>
